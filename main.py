...
async def help(update, context):
    await update.message.reply_text(
        ...
        "необходимо ввести код валюты(RUB, USD). \n \nСписок всех доступных в этом боте валют: USD, EUR, GBP, JPY, "
        "CNY, KZT, TRY, CHF, AUD, AZN, AMD, THB, BYN, BGN, BRL, KRW, HKD, UAH, DKK, AED, VND, EGP, PLN, INR, RUB")
